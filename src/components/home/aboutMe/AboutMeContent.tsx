  ...
  return (
    <>
      ...
      >
        ...
        at my first job. In addition to my primary responsibilities, I also took
        on tasks such as resolving technology problems on various devices (e.g.,
        PCs/laptops, printers, portable mobile terminal lasers) and creating
        small programs in Microsoft Excel to perform calculations.
        <div>
          ...
          project grow and become a useful tool for others and solving problem.
        ...
        <div>
          Outside of coding, I prioritize fitness, whether it's hitting the gym
          or spending quality time with my dog or cat. I have a strong passion
          for continuous learning and am currently exploring System Design
          concepts.
        </div>
      </div>
    </>
